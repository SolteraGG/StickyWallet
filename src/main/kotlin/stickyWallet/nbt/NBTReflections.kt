...
object NBTReflections {
    ...
    private val nmsVersion: String
        get() = StickyPlugin.instance.nmsManager.getVersionString()
    ...
    fun setString(item: ItemStack, key: String, value: String): ItemStack? {
        var nmsItem = getNMSItemStack(item) ?: return null
        val nbtTag = getNBTTagCompound(nmsItem) ?: getNewNBTTag()!!
    ...
    fun getString(item: ItemStack, key: String): String? {
        val nmsItem = getNMSItemStack(item) ?: return null
        val nbtTag = getNBTTagCompound(nmsItem) ?: getNewNBTTag()!!
