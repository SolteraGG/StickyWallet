    ...
    fun loadDefaultConfig() {
        ...
        config.options()
            .header("""
                ...
                Developer(s): ${plugin.description.authors.joinToString(", ")}
                
                You have two valid storage methods: "yaml", or "postgres".
                If you choose "postgres", please enter the database credentials down below.\n
            """.trimIndent())
