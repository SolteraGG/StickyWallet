...
class Configuration(private val plugin: StickyWallet) {
    ...
    fun loadDefaultConfig() {
        ...
        config.addDefault(path + "help.eco_command", listOf(
        ...
        config.addDefault(path + "help.exchange_command", listOf(
        ...
        config.addDefault(path + "help.cheque_command", listOf("{prefix}&e&lCheque Help",
        ...
        config.addDefault(path + "help.currency_command", listOf("{prefix}&e&lCurrency Help",
